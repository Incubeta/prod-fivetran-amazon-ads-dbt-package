{{ config(enabled=var('amazon_ads__brandcampaignvideo_enabled', True))}}
{{
config(
	alias=var('amazon_ads__sponsored_brandcampaignvideo_alias','amazon-ad_performance-sponsored_brandcampaignvideo-v1' ),
	partition_by={
      "field": "date",
      "data_type": "date",
      "granularity": "day"
